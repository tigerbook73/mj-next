...
export const currentPlayerClasses = "bg-amber-400/60 ring-2 ring-inset ring-amber-400/60";
...
export function useIsCurrentPlayer(direction: Direction): boolean {
  ...
  return game != null && myPosition != null && game.current?.position === CommonUtil.mapPosition(myPosition, direction);
}
